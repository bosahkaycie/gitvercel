      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          <div className="space-y-6 lg:col-span-1">
            ...
            <div className="pt-2">
              <a href={CONTACT_CONFIG.linkedin} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-10 h-10 bg-slate-200 text-slate-600 hover:bg-emerald-600 hover:text-white transition-all">
